...
const Body = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      console.log("Data::",res.data.cards[4].card.card.gridElements.infoWithStyle.restaurants)
    ...
    <div className=" body">
      <div className="filter">
        <div className="search">
          <input type="text" placeholder="Search..." className="search-box" value={searchText} onChange={(event)=>{
